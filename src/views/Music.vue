  ...
  <ion-page>
    ...
    <ion-content class="overflow-auto full-screen mt-2">
      <div class="text-center w-full">
        <ion-icon :icon="headset" size="large" class="text-red-400 clipboard-icon"></ion-icon>
      </div>
      <div class="text-center w-full">
        <ion-card-title class="w-full text-3xl">Müzik</ion-card-title>
      </div>
      <div>
        <ion-list>
          <ion-list-header>
...
import { ellipsisVertical, headset, trash } from 'ionicons/icons';
...
export default defineComponent({
  ...
  setup() {
    ...
    const state: any = reactive({
      muzikGorev: computed(() => store.getters.kategoriyeGoreGorevGetir('Müzik')),
      gelen: computed(() => {
