  ...
  <ion-page>
    ...
    <ion-content class="overflow-auto full-screen mt-2">
      <div class="text-center w-full">
        <ion-icon :icon="book" size="large" class="text-purple-500 clipboard-icon"></ion-icon>
      </div>
      <div class="text-center w-full">
        <ion-card-title class="w-full text-3xl">Ders Görevleri</ion-card-title>
      </div>
      <div>
        <ion-list>
          <ion-list-header>
...
export default defineComponent({
  ...
  setup() {
    ...
    const state: any = reactive({
      muzikGorev: computed(() => store.getters.kategoriyeGoreGorevGetir('Ders')),
      gelen: computed(() => {
