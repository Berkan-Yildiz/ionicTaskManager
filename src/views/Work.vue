  ...
  <ion-page>
    ...
    <ion-content class="overflow-auto full-screen mt-2">
      <div class="text-center w-full">
        <ion-icon :icon="briefcase" size="large" class="text-yellow-500 clipboard-icon"></ion-icon>
      </div>
      <div class="text-center w-full">
        <ion-card-title class="w-full text-3xl">İş Görevleri</ion-card-title>
      </div>
      <div>
        <ion-list>
          <ion-list-header>
...
import { ellipsisVertical, briefcase, trash } from 'ionicons/icons';
...
export default defineComponent({
  ...
  setup() {
    ...
    const state: any = reactive({
      muzikGorev: computed(() => store.getters.kategoriyeGoreGorevGetir('İş')),
      gelen: computed(() => {
